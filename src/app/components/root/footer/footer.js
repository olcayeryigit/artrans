...
const Footer = () => {
  return (
    ...
    <Link href="https://www.trendyol.com/magaza/artrans-pazarlama-m-1081382?sst=0" className="bg-white  text-black flex items-center gap-3 0 p-2 rounded-2xl shadow-lg z-50">
