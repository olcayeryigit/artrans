...
<div className="inline md:hidden ">
<svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 24 24"><path fill="#FFF" d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4zm9.65 1.5a1.25 1.25 0 0 1 1.25 1.25A1.25 1.25 0 0 1 17.25 8A1.25 1.25 0 0 1 16 6.75a1.25 1.25 0 0 1 1.25-1.25M12 7a5 5 0 0 1 5 5a5 5 0 0 1-5 5a5 5 0 0 1-5-5a5 5 0 0 1 5-5m0 2a3 3 0 0 0-3 3a3 3 0 0 0 3 3a3 3 0 0 0 3-3a3 3 0 0 0-3-3"></path></svg></div>

          </Link>
         

    <Link href="https://www.trendyol.com/magaza/artrans-pazarlama-m-1081382?sst=0" className=" hidden bg-white  text-black md:flex items-center gap-3 0 p-2 rounded-2xl shadow-lg z-50">
	  ...
	  <p className=''>Trendyol mağazamız için tıkla </p>
    

    </Link>
          </div>
          
    <Link href="https://www.trendyol.com/magaza/artrans-pazarlama-m-1081382?sst=0" className=" bg-white  text-black md:hidden items-center justify-center p-2 rounded-2xl shadow-lg z-50">
	  ...
	  <p className=''>Trendyol mağazamız için tıkla </p>
        ...
        <div className="text-center mt-8 text-sm">
          <p>&copy; 2025 Tüm Hakları Saklıdır | Artrans Pazarlama</p>
        </div>
      </div>
    </footer>
  );
