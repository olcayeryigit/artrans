...
const About = () => {
  return (
    <section id="about" className="bg-gray-50 mt-8 md:mt-44 py-4 md:pt-20 px-8 md:px-0">
      <div className="container mx-auto flex">
        {/* Dikey Artrans Pazarlama */}
        <h1 className="hidden md:block text-6xl  h-20 md:w-48 font-bold text-gray-800 opacity-10 transform -rotate-90  md:mt-72 ">
          ARTRANS PAZARLAMA
        </h1>
        <div>
        <h2 className=" text-md md:text-3xl font-bold text-gray-800 mb-2 md:mb-6">
          Hakkımızda - Artrans Pazarlama
        </h2>
        <p className="text-gray-700 text-xs md:text-lg leading-relaxed  mb-2 md:mb-8">
